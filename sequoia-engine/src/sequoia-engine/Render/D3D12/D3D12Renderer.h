...
#ifndef SEQUOIA_ENGINE_RENDER_D3D12_D3D12RENDERER_H
#define SEQUOIA_ENGINE_RENDER_D3D12_D3D12RENDERER_H
...
/// @brief D3D12 Renderer implementation
/// @ingroup d3d12
class SEQUOIA_API D3D12Renderer final : public Renderer {
protected:
  using Base = Renderer;
