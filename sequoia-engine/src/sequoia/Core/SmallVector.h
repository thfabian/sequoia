...
#include "sequoia/Core/AlignOf.h"
#include "sequoia/Core/MathExtras.h"
#include "sequoia/Core/type_traits.h"
#include <algorithm>
#include <cassert>
#include <cstddef>
#include <cstdlib>
...
public:
  void push_back(const T& Elt) {
    if(SEQUOIA_BUILTIN_UNLIKELY(this->EndX >= this->CapacityX))
      this->grow();
...
template <class T>
using SmallVectorImpl = core::SmallVectorImpl<T>;

template <class T, unsigned N>
using SmallVector = core::SmallVector<T, N>;
...
template <typename T>
inline void swap(sequoia::SmallVectorImpl<T>& LHS, sequoia::SmallVectorImpl<T>& RHS) {
  LHS.swap(RHS);
}

/// @brief Implement std::swap in terms of SmallVector swap.
template <typename T, unsigned N>
inline void swap(sequoia::SmallVector<T, N>& LHS, sequoia::SmallVector<T, N>& RHS) {
  LHS.swap(RHS);
}
