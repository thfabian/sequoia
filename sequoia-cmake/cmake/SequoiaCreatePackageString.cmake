...
function(sequoia_create_package_string NAME PACKAGE_STRING)
  ...
  if(NOT(${SEQUOIA_${package}_FOUND}))
     set(info "${not_found_string}")
  else()
    if(DEFINED SEQUOIA_${package}_LIBRARIES)
      list(GET SEQUOIA_${package}_LIBRARIES 0 lib)
      set(info "${lib}")
    elseif(DEFINED SEQUOIA_${package}_INCLUDE_DIRS)
